...
<p align="center">
  ...
  &nbsp;
  <img src="https://komarev.com/ghpvc/?username=jdiassdev&color=7C3AED&style=for-the-badge&label=Views" />
</p>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=FFFFFF&center=true&vCenter=true&pause=1000&width=430&lines=Back-End+Developer;NestJS+%7C+Laravel+%7C+Spring+Boot;Clean+APIs+%26+Scalable+Systems;Open+to+new+opportunities;Sic+Parvis+Magna" alt="Typing SVG" />
</p>
...
<img width="40%" align="right" alt="Coding" src="https://raw.githubusercontent.com/TheDudeThatCode/TheDudeThatCode/master/Assets/Developer.gif" />
...
🗃️ Design and optimization of **SQL and NoSQL** databases with focus on performance.

🐳 Experience with **Docker** and modern DevOps practices.

🧠 **Monolith-first** — modular, domain-scoped systems ready to scale. Microservices only when real metrics justify the complexity.

📍 Brazil — open to **remote, hybrid or on-site** opportunities.
...
<br/>Laravel library that **automatically generates TypeScript interfaces** from `FormRequests` — eliminates manual type duplication between backend and frontend.
...
<br/>Minimalist REST API for barbershop management built with Laravel 12.
